...
public class DeleteWorker extends Worker {
    ...
    public Result doWork() {
        ...
        try {
            Log.d("statusCode", String.valueOf("http://ec2-54-93-62-124.eu-central-1.compute.amazonaws.com/pllano002/WEB/HealthMate/DeleteData.php"));

            HttpURLConnection urlConnection = null;
            URL url = new URL("http://ec2-54-93-62-124.eu-central-1.compute.amazonaws.com/pllano002/WEB/HealthMate/DeleteData.php");
